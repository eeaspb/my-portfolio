...
> Вызов лифта доступен из паркинга, с первого этажа, а также с этажа, на котором находится ваша квартир  
...
3. Нажмите кнопку **«Управление лифтами»** (рис. 1). Откроется экран **«Вызов лифта»**.
   ...
   <img src="Рисунок 1 - Кнопка Управление лифтами.png" width="120" style="border: 1px solid #ccc; display: block; margin-bottom: 5px;">
...
<img src="Рисунок 2 - Экран Вызов лифта.png" width="250" style="border: 1px solid #ccc; display: block; margin-top: 15px; margin-bottom: 5px;">
...
3. Подождите. Когда лифт окажется на этаже, кнопка вызова лифта станет синей, вокруг загорится сиреневый ободок (рис. 3).
